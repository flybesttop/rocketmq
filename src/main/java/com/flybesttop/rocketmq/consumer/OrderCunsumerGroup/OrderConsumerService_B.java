...
/**
 * @description 顺序消费 消费者 B
 * @author flybesttop
 */
@Component
public class OrderConsumerService_B {
    ...
    public void initConsumer() throws MQClientException {
        ...
        mqPushConsumer.registerMessageListener((MessageListenerOrderly) (list, context) -> {
            try {
                ...
                System.out.printf("%s Receive New Messages: %s %s %n", Thread.currentThread().getName(), "OrderConsumerService_B", new String(list.get(0).getBody()));
...
//                System.out.println("topic=" + topic + ", tags=" + tags + ", keys=" + keys + ", msg=" + body);
        ...
        System.out.println("OrderConsumer_B start ...");
    }
